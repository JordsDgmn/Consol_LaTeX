...
\usepackage{caption}
\usepackage{float}
\usepackage{booktabs} % add this in your preamble for nicer tables
\usepackage{graphicx}
\usepackage{tabularx}
...
\author{by\\
        Joanna R. Giga\\
        Nawawi A. Palawan\\
        John Lenard R. Requina}                              % your names
%\authorID{123456M}                                  % your University Identifier (not used)
\supervisor{Jennifer Joyce M. Montemayor, MSc}                 % your supervisor(s) name - no . in Dr
...
\degreedate{May, 2025}                         % when did you submit -- officially after your corrections !
...
\begin{document}
\frontmatter 
    \input{frontmatter/revision_table}       %
...
\mainmatter 
    ...
    \input{chap3/theoretical_framework}
    \input{chap4/methodology}
    \input{chap5/results_and _discussion}
