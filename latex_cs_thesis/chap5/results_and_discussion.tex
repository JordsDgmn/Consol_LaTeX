...
\begin{itemize}
    ...
    \item \textbf{Consistency}: SimCSE demonstrated superior reliability with zero variance across repeated assessments
\end{itemize}
}
...
\midrule
\textbf{Overall Mean} & \textbf{9.54 points} & \textbf{16.33 points} & \textbf{+6.79 points better} \\
\bottomrule
\end{tabular}
}
\end{table}
