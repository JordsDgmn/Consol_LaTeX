...
This integrated foundation encompasses data visualization principles supported by educational technology research (Vișcu, 2024), self-regulated learning theory that emphasizes student autonomy in monitoring their own progress (Baars et al., 2022), and educational measurement approaches that support rather than replace human judgment in learning assessment. Stojanovic et al. (2020) demonstrate that systematic progress tracking through app-based systems effectively reduces motivational impairments during studying by providing structured feedback and consistency visualization that enables learners to maintain educational practices beyond initial motivation phases.
