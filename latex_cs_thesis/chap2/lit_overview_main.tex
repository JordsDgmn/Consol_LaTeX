...
\subsection{App-Based Habit Building to Enhance Study Performance}
...
\begin{figure}[ht!]
    ...
    \]
    {\color{maroon}\tiny\caption[Formula for Contrastive Learning]{Formula for Contrastive Learning}}
...
Cosine similarity quantifies the angular distance between embeddings, ensuring that semantically similar sentences are pulled closer together, while dissimilar ones are pushed apart. The temperature parameter $\tau$ sharpens the similarity distribution, controlling the influence of positive and negative pairs during training. By aligning positive sentence pairs and distributing negatives uniformly in the vector space, SimCSE resolves BERT's anisotropy problem, producing sentence embeddings that are better suited for tasks like paraphrase detection and semantic textual similarity.
...
\begin{figure}[ht!]
    ...
    \]
    {\color{maroon}\scriptsize\caption[Formula for Cosine Similarity]{Formula for Cosine Similarity}}
...
\begin{table}[ht!]
    \centering
    {\color{maroon}\caption[Comparison Table of Related Literature]{Comparison Table of Related Literature}}
