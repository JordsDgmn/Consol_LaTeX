...
\begin{table}[!htbp]
\centering
{\color{maroon}\tiny\caption[Similarity Score Thresholds for Educational Assessment]{Initial similarity score thresholds established for the star rating system based on educational assessment principles}}
...
\begin{table}[!htbp]
\centering
{\color{maroon}\tiny\caption[Test Cases for Scoring Threshold Adjustment]{Test sentences to feed to SimCSE for scoring threshold adjustment, with expected results. Actual scores reflect SimCSE model output during the initial test case feeding onto the barebones SimCSE.}}
...
\begin{table}[!htbp]
\centering
{\color{maroon}\tiny\caption[Test Case Results for Scoring Threshold Adjustment]{Resulting scores of the test cases for scoring threshold adjustment. Actual scores reflect SimCSE model output during the initial test case feeding onto the barebones SimCSE.}}
...
{\color{maroon}\tiny\caption[Development Architecture with API Schema]{Comprehensive development architecture diagram detailing API endpoints, database schema relationships, and system component interactions. The diagram shows the technical infrastructure supporting educational assessment workflows including user management, content processing, and performance analytics.}}
...
\end{minipage}
{\color{maroon}\tiny\caption{Entity-Relationship Diagram of the Consol Database Schema}}
