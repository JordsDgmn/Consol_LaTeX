...
The methodology for Consol's holistic development includes the conception of its system architecture, along with the methods used to arrive at a reasonable threshold for its scoring. These goals aim to satisfy the specific objectives outlined in Chapter \ref{chap:introduction}. 
...
\caption[System Architecture and Data Flow]{{System Architecture}}
...
\caption[PDF Processing Pipeline]{PyPDFLoader Preprocessing Pipeline}
...
\caption[DOCX Processing Pipeline]{Docx2txtLoader Preprocessing Pipeline}
...
\caption[TXT Processing Pipeline]{TextLoader Preprocessing Pipeline}
...
\caption[SimCSE Architecture Implementation]{SimCSE Architecture Diagram }
...
\begin{table}[!htbp]
\centering
\caption[Similarity Score Thresholds for Educational Assessment]{Initial Similarity Score Thresholds}
...
\end{minipage}}
\end{minipage}
\caption[Test Case Scenarios for SimCSE Validation]{Scoring Test Cases for Threshold Adjustment}
...
\begin{table}[!htbp]
\centering
\caption[Test Case Results for Scoring Threshold Adjustment]{{Scoring Test Case Results}}
...
\caption[Development Architecture with API Schema]{Development Architecture Diagram}
...
\caption[User Interaction Flow with Decision Trees]{User Interaction Flow Diagram}
