...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/test-cases.png}
\caption[Test Cases for Scoring Threshold Adjustment]{Test sentences to feed to SimCSE for scoring threshold adjustment, with expected results.}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/test-case-results.png}
\caption[Test Case Results for Scoring Threshold Adjustment]{Resulting scores of the test cases for scoring threshold adjustment.}
\label{fig:test_cases}
\end{figure}
\FloatBarrier
...
This subsection addresses the technical performance characteristics and deployment requirements essential for educational platform reliability and scalability.
